    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form   id="team-form" method="post" action="<?php echo e(route('store-team')); ?>"  enctype="multipart/form-data">
...
</script><?php /**PATH C:\projects\ftb-lara\ftb\resources\views/players-teams/team.blade.php ENDPATH**/ ?>