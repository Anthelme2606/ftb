    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="bc-form" method="post" action="<?php echo e(route('but_carton')); ?>"  enctype="multipart/form-data">
...
</script><?php /**PATH C:\projects\ftb-lara\ftb\resources\views\players-teams\carton-but.blade.php ENDPATH**/ ?>